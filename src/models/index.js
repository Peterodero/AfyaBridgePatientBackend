...
const Prescription = sequelize.define('Prescription', {
  id:                  { type: DataTypes.UUID, defaultValue: UUIDV4, primaryKey: true },
  prescription_number: { type: DataTypes.STRING(100), unique: true },
  patient_id:          { type: DataTypes.UUID, allowNull: false },
  doctor_id:           { type: DataTypes.UUID, allowNull: false },
  pharmacy_id:         { type: DataTypes.UUID },
  dispensed_by:        { type: DataTypes.UUID },
  patient_name:        { type: DataTypes.STRING(255), allowNull: false },
  patient_phone:       { type: DataTypes.STRING(20) },
  patient_address:     { type: DataTypes.STRING(255) },
  doctor_name:         { type: DataTypes.STRING(255), allowNull: false },
  ...
  status:              { type: DataTypes.ENUM('draft','pending','validated','rejected','dispensed','delivered'), defaultValue: 'draft', allowNull: false },
